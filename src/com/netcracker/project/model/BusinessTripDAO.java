...
public interface BusinessTripDAO {
  ...
  String FIND_TRIP_BY_USER_ID =
      "SELECT TRIP_PROJ_REF.OBJECT_ID AS BUSINESS_TRIP_ID, COUNTRY.VALUE AS COUNTRY, START_DATE.VALUE AS START_DATE, "
          + "      END_DATE.VALUE AS END_DATE, TRIP_STATUS_VALUE.VALUE STATUS, TRIP_PROJ_REF.REFERENCE AS PROJECT_ID, AUTHOR_ID_REF.REFERENCE AS AUTHOR_ID, "
