...
public interface ProjectDAO {
  ...
  Integer findProjectByNameIfExist(String name);
  ...
  String FIND_PROJECT_BY_NAME =
      "SELECT PROJECT_ID.OBJECT_ID AS PROJECT_ID, PR_NAME.VALUE AS NAME, START_DATE.DATE_VALUE AS START_DATE, END_DATE.DATE_VALUE AS END_DATE, PM_ID.OBJECT_ID AS PM_ID, PR_STATUS_VALUE.VALUE AS STATUS "
          + "FROM OBJTYPE PR_TYPE, OBJECTS PROJECT_ID, OBJECTS PM_ID, "
          + "ATTRIBUTES PR_NAME, ATTRIBUTES START_DATE, ATTRIBUTES END_DATE, ATTRIBUTES PR_STATUS, "
          + "OBJREFERENCE PM_PROJECT_REF, "
          + "LISTVALUE PR_STATUS_VALUE "
          + "WHERE PR_NAME.VALUE = ? AND "
          + "PR_TYPE.CODE = 'PROJECT' AND "
          + "PR_NAME.ATTR_ID = 14 AND "
          + "PR_NAME.OBJECT_ID = PROJECT_ID.OBJECT_ID AND "
          + "START_DATE.ATTR_ID = 15 AND "
  ...
  String FIND_PROJECT_BY_NAME_IF_EXIST =
      " SELECT COUNT(PROJECT_ID.OBJECT_ID) AS EXIST "
          + " FROM OBJTYPE PR_TYPE, OBJECTS PROJECT_ID, OBJECTS PM_ID, "
          + " ATTRIBUTES PR_NAME, ATTRIBUTES START_DATE, ATTRIBUTES END_DATE, ATTRIBUTES PR_STATUS, "
          + " OBJREFERENCE PM_PROJECT_REF, "
          + " LISTVALUE PR_STATUS_VALUE "
  ...
  String GET_SPRINTS = "SELECT "
      ...
      + " to_char(START_DATE.DATE_VALUE, 'yyyy-MM-dd')    AS "
      + EnumMapper.START_DATE + ", "
      + " to_char(END_DATE.DATE_VALUE, 'yyyy-MM-dd')     AS "
      + EnumMapper.END_DATE + ", "
      + " to_char(PLANNED_END_DATE.DATE_VALUE, 'yyyy-MM-dd') AS "
      + EnumMapper.PLANNED_END_DATE
      + ", "
  ...
  String FIND_SPRINT_BY_SPRINT_ID = "SELECT SPRINT_ID.OBJECT_ID   AS SPRINT_ID, "
      + "  SPRINT_NAME.VALUE   AS NAME, "
      ...
      + "  OBJREFERENCE PROJECT_SPRINT_REF, ATTRIBUTES STATUS, "
      + "  LISTVALUE STATUS_VALUE "
      + "WHERE SPRINT_ID.OBJECT_ID = ? AND "
      + "      PROJECT_SPRINT_REF.ATTR_ID = 60 AND "
      + "      PROJECT_SPRINT_REF.OBJECT_ID = SPRINT_ID.OBJECT_ID AND "
      + "      PROJECT_ID.OBJECT_ID = PROJECT_SPRINT_REF.REFERENCE AND "
      + "      SPRINT_NAME.ATTR_ID = 55 AND "
      + "      SPRINT_NAME.OBJECT_ID = SPRINT_ID.OBJECT_ID AND "
      + "      START_DATE.ATTR_ID = 56 AND "
      + "      START_DATE.OBJECT_ID = SPRINT_ID.OBJECT_ID AND "
      ...
      + "      PLANNED_END_DATE.OBJECT_ID = SPRINT_ID.OBJECT_ID "
      + "      AND STATUS.ATTR_ID = 59 "
      + "      AND STATUS.OBJECT_ID = SPRINT_ID.OBJECT_ID "
      + "      AND STATUS_VALUE.ATTR_ID = 59 "
      + "      AND STATUS_VALUE.LIST_VALUE_ID = STATUS.LIST_VALUE_ID ";
  ...
  String CREATE_SPRINT =
      "INSERT ALL "
          + " INTO OBJECTS (OBJECT_ID,PARENT_ID,OBJECT_TYPE_ID,NAME,DESCRIPTION, OBJECT_VERSION) VALUES (OBJECT_SEQUENCE.NEXTVAL,NULL,7,'Sprint'||?,NULL, 1) "
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (55,OBJECT_SEQUENCE.CURRVAL,?,NULL,NULL) "
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (56,OBJECT_SEQUENCE.CURRVAL,NULL,?,NULL) "
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (57,OBJECT_SEQUENCE.CURRVAL,NULL,?,NULL) "
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (58,OBJECT_SEQUENCE.CURRVAL,NULL,?,NULL) "
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (59,OBJECT_SEQUENCE.CURRVAL,NULL,NULL,?) "
          + " INTO OBJREFERENCE (ATTR_ID,OBJECT_ID,REFERENCE) VALUES (60,OBJECT_SEQUENCE.CURRVAL,?) "
          + " SELECT * FROM dual";
  ...
  String FIND_PROJECT_ID_BY_USER_LOGIN = "SELECT PROJECT_ID.OBJECT_ID "
      ...
      + "ATTRIBUTES USER_LOGIN, ATTRIBUTES PROJECT_STATUS, "
      ...
      + "PROJECT_ID.OBJECT_ID = PROJECT_USER_REF.OBJECT_ID AND "
      + "PROJECT_STATUS.ATTR_ID = 17 AND "
      + "PROJECT_STATUS.OBJECT_ID = PROJECT_ID.OBJECT_ID AND "
      + "PROJECT_STATUS.LIST_VALUE_ID = 0";

  String FIND_PROJECT_ID_BY_PM_LOGIN = "SELECT PROJECT_ID.OBJECT_ID "
      + "FROM OBJECTS PROJECT_ID, OBJECTS USER_ID, "
      + "ATTRIBUTES PROJECT_STATUS, ATTRIBUTES USER_LOGIN, "
      ...
      + "PROJECT_ID.OBJECT_ID = PROJECT_PM_REF.OBJECT_ID AND "
      + "PROJECT_STATUS.ATTR_ID = 17 AND "
      + "PROJECT_STATUS.OBJECT_ID = PROJECT_ID.OBJECT_ID AND "
      + "PROJECT_STATUS.LIST_VALUE_ID = 0";

  String FIND_PROJECT_BY_START_DATE =
      "SELECT PROJECT_ID.OBJECT_ID AS PROJECT_ID, PR_NAME.VALUE AS NAME, START_DATE.DATE_VALUE AS START_DATE, END_DATE.DATE_VALUE AS END_DATE, "
          + "PM_ID.OBJECT_ID AS PM_ID, PR_STATUS_VALUE.VALUE AS STATUS "
  ...
  String FIND_PROJECT_BY_ID_IF_EXIST =
      "SELECT COUNT(PROJECT_ID.OBJECT_ID) AS EXIST "
          + "FROM OBJTYPE PR_TYPE, OBJECTS PROJECT_ID, OBJECTS PM_ID, "
          + "ATTRIBUTES PR_NAME, ATTRIBUTES START_DATE, ATTRIBUTES END_DATE, ATTRIBUTES PR_STATUS, "
          + "OBJREFERENCE PM_PROJECT_REF, "
