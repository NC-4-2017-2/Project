...
public interface ProjectDAO {
  ...
  void createProject(Project project, Collection<Sprint> sprints, Collection<WorkPeriod> workPeriods);
  ...
  String FIND_PROJECT_BY_PROJECT_ID = "SELECT PROJECT_ID.OBJECT_ID AS PROJECT_ID, PR_NAME.VALUE AS NAME, START_DATE.DATE_VALUE AS START_DATE, END_DATE.DATE_VALUE AS END_DATE, "
  ...
  String FIND_PROJECT_BY_NAME = "SELECT PROJECT_ID.OBJECT_ID AS PROJECT_ID, PR_NAME.VALUE AS NAME, START_DATE.DATE_VALUE AS START_DATE, END_DATE.DATE_VALUE AS END_DATE, PM_ID.OBJECT_ID AS PM_ID, PR_STATUS_VALUE.VALUE AS STATUS "
          + "FROM OBJTYPE PR_TYPE, OBJECTS PROJECT_ID, OBJECTS PM_ID, "
          + "ATTRIBUTES PR_NAME, ATTRIBUTES START_DATE, ATTRIBUTES END_DATE, ATTRIBUTES PR_STATUS, "
          + "OBJREFERENCE PM_PROJECT_REF, "
          + "LISTVALUE PR_STATUS_VALUE "
