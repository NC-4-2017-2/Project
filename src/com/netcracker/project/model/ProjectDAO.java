...
public interface ProjectDAO {
  ...
  String CREATE_PROJECT =
      "INSERT ALL "
          ...
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (14,OBJECT_SEQUENCE.CURRVAL,?,NULL,NULL) "
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (15,OBJECT_SEQUENCE.CURRVAL,NULL,?,NULL) "
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (16,OBJECT_SEQUENCE.CURRVAL,NULL,?,NULL) "
          + " INTO ATTRIBUTES (ATTR_ID,OBJECT_ID,VALUE,DATE_VALUE,LIST_VALUE_ID) VALUES (17,OBJECT_SEQUENCE.CURRVAL,NULL,NULL,?)  "
          + " INTO OBJREFERENCE (ATTR_ID,OBJECT_ID,REFERENCE) VALUES (18,OBJECT_SEQUENCE.CURRVAL,?)"
          + " SELECT * FROM dual";
