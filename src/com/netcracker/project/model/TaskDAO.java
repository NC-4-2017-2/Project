...
public interface TaskDAO {
  ...
  Collection<Task> findTaskByProjectIdAndDate(Date date, BigInteger projectId);
  ...
  Collection<Task> findTaskByUserIdAndPriority(Integer taskPriority, BigInteger userId);

  Collection<Task> findTaskByUserIdAndStatus(BigInteger id, Integer taskStatus);
  ...
  String FIND_TASK_BY_PROJECT_ID_AND_TASK_ID =
          ...
          " TASK_REOPEN_COUNTER.VALUE AS REOPEN_COUNTER, TASK_COMMENT.VALUE AS TASK_COMMENT, PROJECT_ID_REF.REFERENCE AS PROJECT_ID, AUTHOR_ID_REF.REFERENCE AS AUTHOR_ID  " +
          " FROM OBJECTS TASK, OBJECTS PROJ, OBJECTS USERS, OBJTYPE TASK_TYPE, " +
          ...
          " OBJREFERENCE PROJECT_ID_REF, OBJREFERENCE AUTHOR_ID_REF " +
          ...
          " AND USERS.OBJECT_ID = AUTHOR_ID_REF.REFERENCE " +
  ...
  String FIND_TASK_BY_USER_ID_AND_PRIORITY =
          ...
          " TASK_START_DATE.DATE_VALUE AS START_DATE, TASK_END_DATE.DATE_VALUE AS END_DATE, TASK_PLANNED_END_DATE.DATE_VALUE AS PLANNED_END," +
