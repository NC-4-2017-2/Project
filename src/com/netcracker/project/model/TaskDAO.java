...
public interface TaskDAO {
  ...
  Collection<Task> findTaskByProjectIdAndPriority(Integer taskPriority, BigInteger projectId);

  Collection<Task> findTaskByProjectIdAndStatus(BigInteger projectId, BigInteger status);
