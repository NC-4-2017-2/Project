...
public interface VacationDAO {
  ...
  String CREATE_VACATION = "INSERT ALL " +
      ...
      "VALUES (OBJECT_SEQUENCE.NEXTVAL, NULL, 5, 'Vacation'|| ?, NULL, 1) " +
      "INTO ATTRIBUTES (ATTR_ID, OBJECT_ID, VALUE,DATE_VALUE,LIST_VALUE_ID) " +
      "VALUES (41, OBJECT_SEQUENCE.CURRVAL, NULL, ?, NULL) " +
      "INTO ATTRIBUTES (ATTR_ID, OBJECT_ID, VALUE,DATE_VALUE,LIST_VALUE_ID) " +
      "VALUES (42, OBJECT_SEQUENCE.CURRVAL, NULL, ?, NULL) " +
      "INTO ATTRIBUTES (ATTR_ID, OBJECT_ID, VALUE,DATE_VALUE,LIST_VALUE_ID) " +
      "VALUES (43, OBJECT_SEQUENCE.CURRVAL, NULL, NULL, ?) " +
      "INTO ATTRIBUTES (ATTR_ID, OBJECT_ID, VALUE,DATE_VALUE,LIST_VALUE_ID) " +
      "VALUES (44, OBJECT_SEQUENCE.CURRVAL, NULL, NULL, ?) " +
