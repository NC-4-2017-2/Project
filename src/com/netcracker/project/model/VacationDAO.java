...
public interface VacationDAO {
  ...
  Collection<Vacation> findVacationByPMIdAndPMStatus(BigInteger pmId, Integer pmStatus);

  Collection<Vacation> findVacationByLMIdAndLMStatus(BigInteger lmId, Integer lmStatus);

  Vacation findVacationById(BigInteger id);
  ...
  String FIND_VACATION_BY_PM_ID_AND_STATUS = "SELECT VACATION_ID.OBJECT_ID AS VACATION_ID, USER_ID.OBJECT_ID AS USER_ID, "
      +"PROJECT_ID.OBJECT_ID AS PROJECT_ID, "
      +"PM_ID.OBJECT_ID AS PM_ID, LM_ID.OBJECT_ID AS LM_ID, "
      +"START_DATE.DATE_VALUE AS START_DATE, END_DATE.DATE_VALUE AS END_DATE, "
      +"PM_STATUS_VALUE.VALUE AS PM_STATUS, LM_STATUS_VALUE.VALUE AS LM_STATUS "
  ...
  String FIND_VACATION_BY_LM_ID_AND_STATUS = "SELECT VACATION_ID.OBJECT_ID AS VACATION_ID, USER_ID.OBJECT_ID AS USER_ID, "
      +"PROJECT_ID.OBJECT_ID AS PROJECT_ID, "
      +"PM_ID.OBJECT_ID AS PM_ID, LM_ID.OBJECT_ID AS LM_ID, "
      +"START_DATE.DATE_VALUE AS START_DATE, END_DATE.DATE_VALUE AS END_DATE, "
      +"PM_STATUS_VALUE.VALUE AS PM_STATUS, LM_STATUS_VALUE.VALUE AS LM_STATUS "
