...
public interface UserDAO {
    ...
    void updateWorkingPeriodByUserId(UserDAO.WorkPeriod workPeriod);
    ...
    String FIND_WORK_PERIOD_BY_USER_ID = "SELECT WORK_PERIOD.OBJECT_ID AS WORK_PERIOD_ID, USER_ID.OBJECT_ID AS USER_ID, PROJECT_ID.OBJECT_ID AS PROJECT_ID, " +
            "START_DATE_ATTR.VALUE AS START_DATE, END_DATE_ATTR.VALUE AS END_DATE, STATUS_ATTR_VALUE.VALUE AS STATUS " +
