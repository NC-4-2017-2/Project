...
public class BusinessTripDAOImpl implements BusinessTripDAO {
    ...
    private static final String FIND_TRIP_BY_USER_ID = "SELECT TRIP.OBJECT_ID AS BUSINESS_TRIP_ID, " +
    ...
    public Collection<BusinessTrip> findTripByUserId(BigInteger id) {
        return template.query(FIND_TRIP_BY_USER_ID, new Object[]{id}, new BusinessTripMapper());
    }
