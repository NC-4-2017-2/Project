...
public class TaskDAOImpl implements TaskDAO {
  ...
  private static final String UPDATE_TASK =
    ...
    @Override
    public Collection<Task> findTaskByPriority(BigInteger taskPriority) {
    ...
    @Override
    public Task findTaskByStatusAndUserId(TaskStatus taskStatus, BigInteger id) {
      logger.info("Entering findTaskByStatusAndUserId(status=" + taskStatus + ", " + "id=" + id + ")");
      return template.queryForObject(FIND_TASK_BY_STATUS_AND_USER_ID, new Object[]{taskStatus, id}, new TaskMapper());
    }
