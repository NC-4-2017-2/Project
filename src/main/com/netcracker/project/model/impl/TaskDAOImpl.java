...
public class TaskDAOImpl implements TaskDAO {
    ...
    private static final String FIND_TASK_BY_PROJECT_ID =
        ...
        " TASK_START_DATE.VALUE AS TASK_START_DATE, TASK_END_DATE.VALUE AS TASK_END_DATE, TASK_PLANNED_END_DATE.VALUE AS TASK_PLANNED_END_DATE, " +
    ...
    public void updateStatus(Integer taskStatus, BigInteger taskId) {
      ...
      template.update(UPDATE_STATUS, taskStatus, taskId);
    }
}
