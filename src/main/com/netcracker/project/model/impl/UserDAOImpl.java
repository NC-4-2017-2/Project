...
public class UserDAOImpl implements UserDAO {
    ...
    private static final String FIND_WORK_PERIOD_BY_USER_ID = "SELECT WORK_PERIOD.OBJECT_ID AS WORK_PERIOD_ID, USER_ID.OBJECT_ID AS USER_ID, PROJECT_ID.OBJECT_ID AS PROJECT_ID, " +
    ...
    private static final String FIND_WORK_PERIOD_BY_PROJECT_ID = "SELECT WORK_PERIOD.OBJECT_ID AS WORK_PERIOD_ID, USER_ID.OBJECT_ID AS USER_ID, PROJECT_ID.OBJECT_ID AS PROJECT_ID, " +
            "START_DATE_ATTR.VALUE AS START_DATE, END_DATE_ATTR.VALUE AS END_DATE " +
            "FROM OBJECTS USER_ID, OBJECTS PROJECT_ID, OBJECTS WORK_PERIOD, " +
            "OBJREFERENCE USER_WP_REF, OBJREFERENCE PROJECT_WP_REF, " +
            "ATTRIBUTES START_DATE_ATTR, ATTRIBUTES END_DATE_ATTR " +
    ...
    private static final String FIND_WORK_PERIOD_BY_USER_ID_AND_PROJECT_ID = "SELECT WORK_PERIOD.OBJECT_ID AS WORK_PERIOD_ID, USER_ID.OBJECT_ID AS USER_ID, PROJECT_ID.OBJECT_ID AS PROJECT_ID, " +
            "START_DATE_ATTR.VALUE AS START_DATE, END_DATE_ATTR.VALUE AS END_DATE " +
            "FROM OBJECTS USER_ID, OBJECTS PROJECT_ID, OBJECTS WORK_PERIOD," +
            "OBJREFERENCE USER_WP_REF, OBJREFERENCE PROJECT_WP_REF, " +
            "ATTRIBUTES START_DATE_ATTR, ATTRIBUTES END_DATE_ATTR " +
