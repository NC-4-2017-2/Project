...
public interface UserDAO {
  ...
  User findFullUserByUserLogin(String login);

  User findFullUserByUserId(BigInteger id);
  ...
  Integer findUserByLoginIfExists(String login);

  Integer findUserByUserIdIfExists(BigInteger id);
  ...
  String FIND_USER_BY_LOGIN_IF_EXISTS =
  ...
  String FIND_USER_BY_USER_ID_IF_EXISTS = "SELECT COUNT(EMP.OBJECT_ID) AS EXIST "
      + "FROM OBJTYPE EMP_TYPE, OBJECTS EMP, "
      + "ATTRIBUTES EMP_LAST_NAME, ATTRIBUTES EMP_FIRST_NAME, ATTRIBUTES EMP_EMAIL, "
      + "ATTRIBUTES EMP_BIRTH_DATE, ATTRIBUTES EMP_HIRE_DATE, ATTRIBUTES EMP_PHONE_NUMBER, "
      + "ATTRIBUTES EMP_JOB_TITLE, ATTRIBUTES EMP_PROJECT_STATUS, "
  ...
  String FIND_FULL_USER_BY_USER_LOGIN = "SELECT EMP.OBJECT_ID AS USER_ID, EMP_LAST_NAME.VALUE AS LAST_NAME, EMP_FIRST_NAME.VALUE AS FIRST_NAME, EMP_EMAIL.VALUE AS EMAIL, "
      + "EMP_BIRTH_DATE.DATE_VALUE AS BIRTH_DATE, EMP_HIRE_DATE.DATE_VALUE AS HIRE_DATE, EMP_PHONE_NUMBER.VALUE AS PHONE_NUMBER, "
      + "EMP_JOB_TITLE_VALUE.VALUE AS JOB_TITLE, EMP_PROJECT_STATUS_VALUE.VALUE AS STATUS, EMP_LOGIN.VALUE AS USER_NAME, EMP_PROJECT_SYSTEM_VALUE.VALUE AS USER_SYSTEM_STATUS "
      + "FROM OBJTYPE EMP_TYPE, OBJECTS EMP, "
      + "ATTRIBUTES EMP_LAST_NAME, ATTRIBUTES EMP_FIRST_NAME, ATTRIBUTES EMP_EMAIL, "
      + "ATTRIBUTES EMP_BIRTH_DATE, ATTRIBUTES EMP_HIRE_DATE, ATTRIBUTES EMP_PHONE_NUMBER, "
      + "ATTRIBUTES EMP_JOB_TITLE, ATTRIBUTES EMP_PROJECT_STATUS, ATTRIBUTES EMP_LOGIN, ATTRIBUTES EMP_SYSTEM_STATUS, "
      + "LISTVALUE EMP_JOB_TITLE_VALUE, LISTVALUE EMP_PROJECT_STATUS_VALUE , LISTVALUE EMP_PROJECT_SYSTEM_VALUE "
      + "WHERE EMP_TYPE.OBJECT_TYPE_ID = 1 AND "
      + "EMP.OBJECT_TYPE_ID = EMP_TYPE.OBJECT_TYPE_ID AND "
      + "EMP_LAST_NAME.ATTR_ID = 1 AND "
      + "EMP_LAST_NAME.OBJECT_ID = EMP.OBJECT_ID AND "
      ...
      + "EMP_SYSTEM_STATUS.ATTR_ID = 13 AND "
      + "EMP_SYSTEM_STATUS.OBJECT_ID = EMP.OBJECT_ID AND "
      + "EMP_PROJECT_SYSTEM_VALUE.ATTR_ID = EMP_SYSTEM_STATUS.ATTR_ID AND "
      + "EMP_PROJECT_SYSTEM_VALUE.LIST_VALUE_ID = EMP_SYSTEM_STATUS.LIST_VALUE_ID";

  String FIND_FULL_USER_BY_USER_ID = "SELECT EMP.OBJECT_ID AS USER_ID, EMP_LAST_NAME.VALUE AS LAST_NAME, EMP_FIRST_NAME.VALUE AS FIRST_NAME, EMP_EMAIL.VALUE AS EMAIL, "
      + " EMP_BIRTH_DATE.DATE_VALUE AS BIRTH_DATE, EMP_HIRE_DATE.DATE_VALUE AS HIRE_DATE, EMP_PHONE_NUMBER.VALUE AS PHONE_NUMBER, "
      + " EMP_JOB_TITLE_VALUE.VALUE AS JOB_TITLE, EMP_PROJECT_STATUS_VALUE.VALUE AS STATUS, EMP_LOGIN.VALUE AS USER_NAME, EMP_PROJECT_SYSTEM_VALUE.VALUE AS USER_SYSTEM_STATUS "
      + " FROM OBJTYPE EMP_TYPE, OBJECTS EMP, "
      + " ATTRIBUTES EMP_LAST_NAME, ATTRIBUTES EMP_FIRST_NAME, ATTRIBUTES EMP_EMAIL, "
