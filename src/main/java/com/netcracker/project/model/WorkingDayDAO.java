...
public interface WorkingDayDAO {
  ...
  void updateDisapprovedWorkingHours(BigInteger workingDayId, Double hours);

  WorkingDay findWorkingDayById(BigInteger id);

  WorkingDay findWorkingDayByUserIdAndDate(BigInteger userId,
      Date workingDayDate);

  Collection<WorkingDay> findWorkingDayPerPeriod(BigInteger userId,
      Date startDate, Date endDate);

  Collection<WorkingDay> findWorkingDayByPMIdAndStatus(BigInteger pmId,
      Integer status);

  Collection<WorkingDay> findWorkingDayByUserIdAndStatus(BigInteger userId,
      Integer status);
  ...
  String FIND_WORKING_DAY_BY_ID =
      "SELECT WD_ID.OBJECT_ID AS WORKING_DAY_ID, USER_ID.OBJECT_ID AS USER_ID, PM_ID.OBJECT_ID AS PM_ID, "
  ...
  String FIND_WORKING_DAY_BY_USER_ID_AND_DATE =
      "SELECT WD_ID.OBJECT_ID AS WORKING_DAY_ID, USER_ID.OBJECT_ID AS USER_ID, PM_ID.OBJECT_ID AS PM_ID, "
  ...
  String FIND_WORKING_DAYS_BY_PM_ID_AND_STATUS =
      "SELECT WD_ID.OBJECT_ID AS WORKING_DAY_ID, USER_ID.OBJECT_ID AS USER_ID, PM_ID.OBJECT_ID AS PM_ID, "
          + "WORKING_DAY_DATE.DATE_VALUE AS WORKING_DATE, WORKING_DAY_WEEK_NUMBER.VALUE AS WEEK_NUMBER, WORKING_HOURS_COUNT.VALUE AS WORKING_HOURS, WORKING_HOURS_STATUS_VALUE.VALUE AS STATUS "
          + "FROM OBJECTS WD_ID, OBJECTS USER_ID, OBJECTS PM_ID, "
          + "ATTRIBUTES WORKING_DAY_DATE, ATTRIBUTES WORKING_DAY_WEEK_NUMBER, ATTRIBUTES WORKING_HOURS_COUNT, ATTRIBUTES WORKING_HOURS_STATUS, "
  ...
  String FIND_WORKING_DAY_BY_USER_ID_AND_STATUS =
      "SELECT WD_ID.OBJECT_ID AS WORKING_DAY_ID, USER_ID.OBJECT_ID AS USER_ID, PM_ID.OBJECT_ID AS PM_ID, "
          + "WORKING_DAY_DATE.DATE_VALUE AS WORKING_DATE, WORKING_DAY_WEEK_NUMBER.VALUE AS WEEK_NUMBER, WORKING_HOURS_COUNT.VALUE AS WORKING_HOURS, WORKING_HOURS_STATUS_VALUE.VALUE AS STATUS "
          + "FROM OBJECTS WD_ID, OBJECTS USER_ID, OBJECTS PM_ID, "
          + "ATTRIBUTES WORKING_DAY_DATE, ATTRIBUTES WORKING_DAY_WEEK_NUMBER, ATTRIBUTES WORKING_HOURS_COUNT, ATTRIBUTES WORKING_HOURS_STATUS, "
  ...
  String UPDATE_DISAPPROVED_WORKING_HOURS = "UPDATE ATTRIBUTES "
      + "SET VALUE = ? "
      + "WHERE OBJECT_ID = ?"
      + "AND ATTR_ID = 51";
  ...
  String FIND_WORKING_DAY_IF_EXISTS = "SELECT COUNT(WD_ID.OBJECT_ID) "
      + "FROM OBJECTS WD_ID, OBJECTS USER_ID, OBJECTS PM_ID, "
      + "ATTRIBUTES WORKING_DAY_DATE, ATTRIBUTES WORKING_DAY_WEEK_NUMBER, ATTRIBUTES WORKING_HOURS_COUNT, ATTRIBUTES WORKING_HOURS_STATUS, "
      + "OBJREFERENCE WD_USER_REF, OBJREFERENCE WD_PM_REF, "
      + "LISTVALUE WORKING_HOURS_STATUS_VALUE "
  ...
  String FIND_WORKING_DAY_IF_EXISTS_BY_WORKING_DAY_ID =
      "SELECT COUNT(WD_ID.OBJECT_ID) "
          + "FROM OBJECTS WD_ID, OBJECTS USER_ID, OBJECTS PM_ID, "
          + "ATTRIBUTES WORKING_DAY_DATE, ATTRIBUTES WORKING_DAY_WEEK_NUMBER, ATTRIBUTES WORKING_HOURS_COUNT, ATTRIBUTES WORKING_HOURS_STATUS, "
          + "OBJREFERENCE WD_USER_REF, OBJREFERENCE WD_PM_REF, "
          + "LISTVALUE WORKING_HOURS_STATUS_VALUE "
