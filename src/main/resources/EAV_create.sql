...
CREATE TABLE OBJECTS (
  ...
  CONSTRAINT CON_OBJ_TYPE_ID FOREIGN KEY (OBJECT_TYPE_ID) REFERENCES OBJTYPE (OBJECT_TYPE_ID) ON DELETE CASCADE
);
-----
begin
...
CREATE TABLE ATTRTYPE (
  ...
  CONSTRAINT CON_ATTR_OBJECT_TYPE_ID FOREIGN KEY (OBJECT_TYPE_ID) REFERENCES OBJTYPE (OBJECT_TYPE_ID) ON DELETE CASCADE,
  CONSTRAINT CON_ATTR_OBJECT_TYPE_ID_REF FOREIGN KEY (OBJECT_TYPE_ID_REF) REFERENCES OBJTYPE (OBJECT_TYPE_ID) ON DELETE CASCADE
);
-----
begin
...
INSERT INTO ATTRTYPE (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (63,8,1,'WP_USER','Work period user');
INSERT INTO ATTRTYPE (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (64,8,2,'WP_PROJECT','Project of this working period');
...
INSERT INTO LISTVALUE (ATTR_ID,LIST_VALUE_ID,VALUE) VALUES (17,0,'OPEN');
...
INSERT INTO LISTVALUE (ATTR_ID,LIST_VALUE_ID,VALUE) VALUES (26,0,'COMPLETED');
INSERT INTO LISTVALUE (ATTR_ID,LIST_VALUE_ID,VALUE) VALUES (26,1,'CLOSED');
INSERT INTO LISTVALUE (ATTR_ID,LIST_VALUE_ID,VALUE) VALUES (26,2,'REOPEN');
