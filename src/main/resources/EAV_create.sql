...
INSERT INTO ATTRTYPE (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (70,9,1,'LAST_NAME','User last name');
INSERT INTO ATTRTYPE (ATTR_ID,OBJECT_TYPE_ID,OBJECT_TYPE_ID_REF,CODE,NAME) VALUES (71,9,1,'FIRST_NAME','User first name');
...
BEGIN
   FOR cc IN (SELECT sequence_name  as sequence_exists
                FROM USER_SEQUENCES
               WHERE sequence_name = 'OBJECT_SEQUENCE') LOOP
      -- sequence exists, drop it (at most there will be *one* sequence)
      EXECUTE IMMEDIATE 'DROP SEQUENCE OBJECT_SEQUENCE';
   END LOOP;
   -- create sequence
   EXECUTE IMMEDIATE 'CREATE SEQUENCE OBJECT_SEQUENCE
                      START WITH 1000
                      INCREMENT BY 1
                      NOCACHE
                      NOCYCLE';
